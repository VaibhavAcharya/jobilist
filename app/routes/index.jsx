  ...
  return (
    <Page>
      ...
      <Main className="flex flex-col items-stretch justify-start gap-8">
        ...
        <div className="w-[min(420px,_100%)] mx-auto p-1 rounded-md bg-gradient-to-br from-pink-400 via-blue-400 to-blue-600">
          ...
          <div className="bg-white/5 flex flex-col items-stretch justify-start divide-y divide-dashed divide-neutral-800">
            <div className="py-2 px-4 flex flex-col items-center justify-start gap-1 bg-yellow-800/5">
              ...
              <h2 className="text-center font-bold text-lg text-yellow-200">Launching soon!</h2>
            </div>
            <Form method="post" className="py-8 px-4 flex flex-col items-stretch justify-start gap-4 bg-pink-800/5">
              <div className="flex flex-col items-center justify-center gap-0">
                <Bell size={24} /> 
                <p className="font-medium text-lg px-4 py-2 text-center text-pink-200">Be the first to know when we launch</p>
              </div>
              <div className="mx-auto max-w-[300px]">
                <Field id="email" name="email" type="email" label="Email" placeholder="Eg. john@gmail.com" />
              </div>
              <div className="flex flex-row items-stretch justify-center gap-2">
                <Button type="submit" ghost>Notify me</Button>
              </div>
            </Form>
            <div className="py-8 px-4 flex flex-col items-center justify-start gap-4 bg-green-800/5">
              <div className="flex flex-col items-center justify-center gap-0">
                <Dollar size={24} />
              <p className="font-medium text-lg px-4 py-2 text-center text-green-200">Pre-booking will save you up to 50%</p>
              </div>
              <Button as={Link} to="/post" ghost>Pre book now</Button>
            </div>
          </div>
          </div>
        </div>
