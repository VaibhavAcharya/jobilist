  ...
  return (
    <Page>
      ...
      <Main className="flex flex-col items-stretch justify-start gap-4">
        ...
        <p className="text-neutral-400">Last updated: 13 May 2022</p>
        ...
        <h2 className="font-medium text-xl">Interpretation and Definitions</h2>
        <h3 className="font-medium text-lg">Interpretation</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Definitions</h3>
        <p className="text-neutral-400">
        ...
        <ul className="flex flex-col items-stretch justify-start gap-2">
          ...
          <li>
            <p className="text-neutral-400">
              ...
              in this Agreement) refers to Jobilist, F1, Behind UIT.
            </p>
          </li>
          <li>
            <p className="text-neutral-400">
          ...
          <li>
            <p className="text-neutral-400">
              <strong>Website</strong> refers to Jobilist, accessible from{" "}
              <a
                href="https://www.jobilist.com"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.jobilist.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h3 className="font-medium text-lg">Types of Data Collected</h3>
        <h3 className="font-medium text-lg">Personal Data</h3>
        <p className="text-neutral-400">
        ...
        <ul className="flex flex-col items-stretch justify-start gap-2">
          ...
          <li>
            <p className="text-neutral-400">First name and last name</p>
          </li>
          <li>
          ...
          <li>
            <p className="text-neutral-400">Usage Data</p>
          </li>
        </ul>
        ...
        <ul className="flex flex-col items-stretch justify-start gap-2">
          <li>
            ...
            <p className="text-neutral-400">Type: Session Cookies</p>
            <p className="text-neutral-400">Administered by: Us</p>
            <p className="text-neutral-400">
          ...
          <li>
            ...
            <p className="text-neutral-400">Type: Persistent Cookies</p>
            <p className="text-neutral-400">Administered by: Us</p>
            <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Use of Your Personal Data</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Retention of Your Personal Data</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Transfer of Your Personal Data</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Business Transactions</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Law enforcement</h3>
        <p className="text-neutral-400">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="font-medium text-lg">Other legal requirements</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Security of Your Personal Data</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Children&#x27;s Privacy</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Links to Other Websites</h3>
        <p className="text-neutral-400">
        ...
        <h3 className="font-medium text-lg">Changes to this Privacy Policy</h3>
        <p className="text-neutral-400">
        ...
        <h3 id="contact" className="font-medium text-xl">
          Contact Us
        </h3>
        <ul className="flex flex-col items-stretch justify-start gap-2">
          <li>By email: jobilistcom@gmail.com</li>
          <li>By phone: +919829752166</li>
          <li>By address: F1, Behind UIT, Bhilwara, India</li>
        </ul>
      </Main>
